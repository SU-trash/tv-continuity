...
show.plot_threads = [
    ...
    (9, 122, Plot.CAUSAL, r'''Steven/Amethyst's underground wrestling careers'''),
    (10, 17, Plot.CAUSAL, r'''Steven's pet Lion'''),
    (17, 35, Plot.CAUSAL, r'''Mystery of Lion's mane'''),
    (35, 45, Plot.CAUSAL, r'''Lion's mane-dimension'''),
    (17, 45, Plot.CAUSAL, r'''Steven having seen Rose's Sword/Armory'''),
    ...
    (37, 89, Plot.CAUSAL, "Stevonnie's run-in with Kevin"),
    (37, 138, Plot.CAUSAL, r'''Stevonnie's run-in with Kevin'''),
    ...
    (48, 94, Plot.CAUSAL, r'''Rose/Greg flashback arc'''),
    ...
    (52, 70, Plot.CAUSAL, r'''Cluster arc'''),
    (70, 71, Plot.SERIAL, r'''Cluster arc'''),
    (60, 71, Plot.REFERENTIAL, r'''Gem Mutants'''),
    (71, 72, Plot.CAUSAL, r'''Cluster arc'''),
    (72, 73, Plot.CAUSAL, r'''Cluster arc'''),
    (13, 75, Plot.CAUSAL, r'''Steven's age fluctuation arc'''),
    ...
    (101, 102, Plot.SERIAL, "Rubies' arrival"),
    (101, 102, Plot.CAUSAL, "RQ killed PD arc"),
    ...
    (125, 126, Plot.CAUSAL, r'''Disappearing townies arc'''),
    ...
    (133, 144, Plot.CAUSAL, r'''Dewey having lost his job'''),
