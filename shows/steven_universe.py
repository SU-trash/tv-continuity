...
show.foreshadowing = [
    ...
    ('S1E1', 'S1E7', Foreshadowing.MINOR, 'Bracelet in freezer', 'Steven/Connie and the bracelet'),
    ...
    ('S5E25', 'S5E27', Foreshadowing.MAJOR, "Gem on White Pearl's stomach", 'White Pearl originally belonged to PD')]
