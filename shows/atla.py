...
show.plot_threads = [
    ...
    (46, 1, Plot.CAUSAL, "Backstory of the fire nation and the previous avatar"),
    ...
    (46, 49, Plot.CAUSAL, "Zuko's internal conflict"),
    (39, '50/51', Plot.REFERENTIAL, "Zuko's lightning redirection"),
    (36, '50/51', Plot.CAUSAL, "Suki's capture"),
    (41, '50/51', Plot.SERIAL, "The invasion plan"),
    (44, '50/51', Plot.CAUSAL, "Iroh's escape"),
    (49, '50/51', Plot.CAUSAL, "Zuko's internal conflict"),
    ...
    (41, '54/55', Plot.CAUSAL, "Zuko/Mai's relationship"),
