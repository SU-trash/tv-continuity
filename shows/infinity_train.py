...
show.plot_threads = [
    ...
    (8, 9, Plot.SERIAL, "Loss of Atticus / The Cat's help"),
    (9, 10, Plot.SERIAL, "Plan to save Atticus / confronting Amelia"),
    ...
    (17, 18, Plot.SERIAL, "Jesse gone / reflection police attacking MT"),
    (18, 19, Plot.SERIAL, "MT's plan to get a number"),
    (19, 20, Plot.SERIAL, "MT confronting One-One")]

show.foreshadowing = [
    (1, 5, Foreshadowing.MAJOR, "Conductor briefly flashes by in background when Tulip wakes up; Existence of appearance of the fake Conductor"),
