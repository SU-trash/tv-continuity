...
# (since double-length episodes may take up two 'episode numbers')
episode_indices = {}
for i, ep_num in enumerate(episodes):
    episode_indices[ep_num] = i
    if not isinstance(ep_num, int):
        for s in ep_num.split('/'):
            episode_indices[int(s)] = i
...
plot_threads = [
    ...
    (48, 60, r'''Rose/Greg flashback arc'''),
    (60, 94, r'''Rose/Greg flashback arc'''),
